...
|return_path | string | Email to use for envelope FROM | no | <span class="label label-warning"><strong>Enterprise</strong></span><a href="https://www.sparkpost.com/enterprise-email/">SparkPost Enterprise</a> customers may use this field.<br/>To support Variable Envelope Return Path (VERP), this field provides a specific recipient a unique envelope MAIL FROM. |
...
|token|string| See Push Specific Attributes |required if channel is `gcm` or `apns`|<span class="label label-warning"><strong>Enterprise</strong></span> <a href="https://www.sparkpost.com/enterprise-email/">SparkPost Enterprise</a> customers may use this field. |
|app_id|string|See Push Specific Attributes |required if channel is `gcm` or `apns`| <span class="label label-warning"><strong>Enterprise</strong></span> <a href="https://www.sparkpost.com/enterprise-email/">SparkPost Enterprise</a> customers may use this field. |
##### Notes on channel
