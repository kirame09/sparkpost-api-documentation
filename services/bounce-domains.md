...
<div class="alert alert-info"><strong>Note</strong>: This endpoint is available in the SparkPost API only.</div>
...
<div class="alert alert-info"><strong>Note</strong>: Use of a bounce domain requires modification of your DNS records to include a CNAME record.</div>
